...
\begin{itemize}
	...
	\item le magliette fra le quali l'utente potrà scegliere, descritte da nome, colore, modello (per
	esempio, manica lunga, manica corta, materiale), modalità di stampaggio (per esempio, solo fronte, 
	solo retro, fronte e retro), prezzo, disponibilità
	...
	spedizione, stato dell'ordine (evaso, cioè affidato al corriere, non evaso, cioè in stampa,
	non ancora gestito, annullato), identificatore della spedizione
\end{itemize}
Verrà inoltre realizzata la gerachia delle diverse tipologie di utenti del sito.\\
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item la pagina per l'annullamento dell'ordine (fino a quando non è ancora stato evaso, cioè in 
	...
	\begin{itemize}
		...
		carico (può avere anche più ordini in carico)
		\item la pagina degli ordini che ha già in carico
	...
	\end{itemize}
	\item l'amministratore che dovrà gestire gli account degli utenti registrati e degli operai 
	dell'azienda. Potrà inoltre visualizzare:
	\begin{itemize}
