...
\begin{frame}
	...
	\begin{itemize}
		\item <1-> essere una \textbf{vetrina} per la vendita on-line di \textbf{magliette}
		\item <2-> fornire ai visitatori un'applicazione facile da usare per creare magliette
		\textbf{personalizzate} con stampe anche inviate dagli stessi clienti
		\item <3-> permettere a ""artigiani della maglietta"" di \textbf{ampliare il loro mercato} 
		e di essere assistiti nei \textbf{processi di lavoro}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.4\textwidth}
			\begin{itemize}
				\item <1-> Cliente
				\item <1-> Operaio Stampatore
				\item <2-> \textbf{Stampa}
				\item <2-> Tema
				\item <3-> \textbf{Maglietta} 
				\item <3-> Colore
				\item <3-> Sesso
			\end{itemize}
		\end{column}
		\begin{column}{0.4\textwidth}
			\begin{itemize}
				...
				\item <3-> Foto
				\item <4-> Template
				\item <5-> Configurazione
				\item <5-> Riga di un Ordine
				\item <5-> \textbf{Ordine}
				\item <6-> \textbf{Pagina}
			\end{itemize}
		\end{column}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.4\textwidth}
			\begin{itemize}
				\item <1-> \underline{Pubblica} con le seguenti aree:
					\begin{itemize}
						\item Home Page
						\item Prodotti
						\item Informazioni
					\end{itemize}
				\item <2-> \underline{Cliente} con le seguenti aree:
					\begin{itemize}
						\item Web Market
						\item Informazioni 
						\item Ordini
		...
		\begin{column}{0.4\textwidth}
			\begin{itemize}
				\item <3-> \underline{Stampatore} con le seguenti aree:
					\begin{itemize}
						\item Gestione Ordini
						\item Gestione Account
					\end{itemize}
				\item <4-> \underline{Amministratore} con le seguenti aree:
					\begin{itemize}
...
\begin{frame}
	\frametitle{Sotto-schema di interconnessione}
	\begin{center}
...
\begin{frame}
	\frametitle{Dizionario dei Dati: MAGLIETTA 2}
			\begin{longtable}{|l|p{0.7\columnwidth}|}
				\hline
				Proprietà & \underline{OID}: chiave univoca dell'entità considerata\\
				...
				& \underline{StampabileFronte(boolean)}: possibilità di scelta di una stampa sul fronte della maglietta
				in fase di configurazione\\
				& \underline{StampabileRetro(boolean)}: possibilità di scelta di una stampa sul retro della maglietta
				in fase di configurazione\\
				& \underline{Materiale(string)}\\
				& \underline{Prezzo(float)}\\
				& \underline{isActive(boolean)}: se true la maglietta è visualizzata dagli utenti finali\\
				\hline
			\end{longtable}
\end{frame}
\begin{frame}
...
\begin{frame}
	...
	\begin{longtable}{|l|p{0.7\columnwidth}|}
		...
		& \underline{isActive(boolean)}: se true la stampa è visualizzabile dagli utenti finali\\
		\hline
	\end{longtable}
\end{frame}
\begin{frame}
